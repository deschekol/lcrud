...
<div class="container">
    ...
    <form class="text-center border border-light p-5" action="{{ route('update', $student->id) }}" method="POST">
        ...
        <!-- Phone number -->
        <input type="text" id="defaultRegisterPhonePassword" class="form-control" value="{{ $student->phone }}" placeholder="Phone number"
            name="phone" aria-describedby="defaultRegisterFormPhoneHelpBlock">
